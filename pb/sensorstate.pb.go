...
type BrakeManager struct {
	...
	HydrolicPressureLoss                               int64               `protobuf:"varint,2,opt,name=hydrolic_pressure_loss,json=hydrolicPressureLoss,proto3" json:"hydrolic_pressure_loss,omitempty"`
	CriticalPodAccelerationMesureTimeout               int64               `protobuf:"varint,3,opt,name=critical_pod_acceleration_mesure_timeout,json=criticalPodAccelerationMesureTimeout,proto3" json:"critical_pod_acceleration_mesure_timeout,omitempty"`
	CriticalPodDecelerationInstructionTimeout          int64               `protobuf:"varint,4,opt,name=critical_pod_deceleration_instruction_timeout,json=criticalPodDecelerationInstructionTimeout,proto3" json:"critical_pod_deceleration_instruction_timeout,omitempty"`
	VerinBlocked                                       int64               `protobuf:"varint,5,opt,name=verin_blocked,json=verinBlocked,proto3" json:"verin_blocked,omitempty"`
	EmergencyValveOpenWithoutHydrolicPressorDiminution int64               `protobuf:"varint,6,opt,name=emergency_valve_open_without_hydrolic_pressor_diminution,json=emergencyValveOpenWithoutHydrolicPressorDiminution,proto3" json:"emergency_valve_open_without_hydrolic_pressor_diminution,omitempty"`
	CriticalEmergencyBrakesWithoutDeceleration         int64               `protobuf:"varint,7,opt,name=critical_emergency_brakes_without_deceleration,json=criticalEmergencyBrakesWithoutDeceleration,proto3" json:"critical_emergency_brakes_without_deceleration,omitempty"`
	MesuredDistanceLessThanDesired                     int64               `protobuf:"varint,8,opt,name=mesured_distance_less_than_desired,json=mesuredDistanceLessThanDesired,proto3" json:"mesured_distance_less_than_desired,omitempty"`
	MesuredDistanceGreaterAsDesired                    int64               `protobuf:"varint,9,opt,name=mesured_distance_greater_as_desired,json=mesuredDistanceGreaterAsDesired,proto3" json:"mesured_distance_greater_as_desired,omitempty"`
}
...
func (x *BrakeManager) GetHydrolicPressureLoss() int64 {
	if x != nil {
...
func (x *BrakeManager) GetCriticalPodAccelerationMesureTimeout() int64 {
	if x != nil {
...
func (x *BrakeManager) GetCriticalPodDecelerationInstructionTimeout() int64 {
	if x != nil {
...
func (x *BrakeManager) GetVerinBlocked() int64 {
	if x != nil {
...
func (x *BrakeManager) GetEmergencyValveOpenWithoutHydrolicPressorDiminution() int64 {
	if x != nil {
...
func (x *BrakeManager) GetCriticalEmergencyBrakesWithoutDeceleration() int64 {
	if x != nil {
...
func (x *BrakeManager) GetMesuredDistanceLessThanDesired() int64 {
	if x != nil {
...
func (x *BrakeManager) GetMesuredDistanceGreaterAsDesired() int64 {
	if x != nil {
...
var file_pb_sensorstate_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x14, 0x68, 0x79, 0x64, 0x72,
	...
	0x28, 0x03, 0x52, 0x24, 0x63, 0x72, 0x69, 0x74, 0x69, 0x63, 0x61, 0x6c, 0x50, 0x6f, 0x64, 0x41,
	...
	0x03, 0x52, 0x0c, 0x76, 0x65, 0x72, 0x69, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x12,
	...
	0x03, 0x52, 0x32, 0x65, 0x6d, 0x65, 0x72, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x56, 0x61, 0x6c, 0x76,
	...
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x2a, 0x63,
	...
	0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x1e, 0x6d, 0x65, 0x73, 0x75, 0x72, 0x65, 0x64, 0x44, 0x69,
	...
	0x28, 0x03, 0x52, 0x1f, 0x6d, 0x65, 0x73, 0x75, 0x72, 0x65, 0x64, 0x44, 0x69, 0x73, 0x74, 0x61,
